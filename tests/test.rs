...
mod tests {
    ...
    use libbitcoinkernel_sys::{
        register_validation_interface, unregister_validation_interface, verify, Block, BlockHeader, BlockIndexInfo, BlockManagerOptions, BlockUndo, ChainParams, ChainType, ChainstateLoadOptions, ChainstateManager, ChainstateManagerOptions, Context, ContextBuilder, KernelError, KernelNotificationInterfaceCallbackHolder, Log, Logger, ProcessBlockError, ScriptPubkey, Transaction, TxOut, Utxo, ValidationInterfaceCallbackHolder, ValidationInterfaceWrapper, VERIFY_ALL_PRE_TAPROOT
    };
    use std::fs::File;
